...
const OTPModal = ({email,accountId}:{email:string, accountId:string}) => {
  ...
  <AlertDialogContent className='shad-alert-dialog'>
    <AlertDialogHeader className='relative flex justify-center'>
      <AlertDialogTitle className='h2 text-center '>Enter your OTP
        <Image src="/assets/icons/close-dark.svg" width={20} height={20} alt="close" onClick={()=>setIsOpen(false)} className='otp-close-button' />
      </AlertDialogTitle>
  ...
  <InputOTPGroup className='shad-otp'>
    ...
    <div className='subtitle-2 mt-2 text-center text-light-100'> Didnt get the code?
